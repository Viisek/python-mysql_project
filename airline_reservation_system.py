...
root = Tk()
root['background']='magenta'
root.title( "DR.BOLD Air Reservation System" )

def passenger():

    master = Tk()
    master.geometry("520x400")
    master['background']='magenta'
    master.title( "DR.BOLD Air Reservation System" )
    ...
    def done():
        ...
        print(dataa)
        db = pymysql.connect(host='localhost', user='root', passwd='vArUn2003!', db='Air_Reservation',
                             autocommit=True)
        cursor = db.cursor()
    ...
    def deletePassenger():
        deletePass = Tk()
        deletePass['background']='magenta'
        deletePass.geometry("700x220")
        deletePass.title("DR.BOLD Air Reservation System")
...
#Change seat number
    ...
    def deleteTicket():
        ...
        deleteTick = Tk()
        deleteTick['background']='magenta'
        deleteTick.geometry("450x220")
        deleteTick.title("DR.BOLD Air Reservation System")
...
def flight():
    ...
    def deleteFlight():
        deleteFli = Tk()
        deleteFli['background']='magenta'
        deleteFli.geometry("700x220")
        deleteFli.title("DR.BOLD Air Reservation System")
...
label = Label(root, text="WELCOME TO THE DR.BOLD Air Reservation System")
label.pack()
...
myButtone.pack()
myButtonb = Button(root, text = "Sales graph", command=graph)
myButtonb.pack()
